...
public class GemstoneGrinderBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public GemstoneGrinderBlock(Settings settings) {
        super(settings);
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof GemstoneGrinderBlockEntity) {
                ItemScatterer.spawn(world, pos, (GemstoneGrinderBlockEntity) blockEntity);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (!world.isClient) {
            NamedScreenHandlerFactory screenHandlerFactory = ((GemstoneGrinderBlockEntity) world.getBlockEntity(pos));
