package net.samu.mineloween.datagen.recipe;
...
public class GemstoneGrinderRecipeBuilder implements CraftingRecipeJsonBuilder{
    private final Item result;
    private final Ingredient ingredient;
    private final int count;
    private final Advancement.Builder advancement = Advancement.Builder.create();

    public GemstoneGrinderRecipeBuilder(ItemConvertible ingredient, ItemConvertible result, int count) {
    ...
    public static class JsonBuilder implements RecipeJsonProvider {
        ...
        public Identifier getRecipeId() {
            return new Identifier(MineloweenMod.MOD_ID,
                    Registries.ITEM.getId(this.result).getPath() + "_from_gemstone_grinder");
        }

        @Override
        public RecipeSerializer<?> getSerializer() {
            return GemstoneGrinderRecipe.Serializer.INSTANCE;
        }
