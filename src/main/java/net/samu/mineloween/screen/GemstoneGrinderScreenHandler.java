...
public class GemstoneGrinderScreenHandler extends ScreenHandler {
    private final Inventory inventory;
    private final PropertyDelegate propertyDelegate;
    private final GemstoneGrinderBlockEntity blockEntity;

    protected GemstoneGrinderScreenHandler(int syncId, PlayerInventory inventory, PacketByteBuf buf) {
    ...
    public GemstoneGrinderScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity, PropertyDelegate arrayPropertyDelegate) {
        ...
        this.blockEntity = ((GemstoneGrinderBlockEntity) blockEntity);
